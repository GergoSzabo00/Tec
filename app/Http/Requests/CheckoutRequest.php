    ...
    public function rules()
    {
        if(auth()->check())
        {
            return [
                ...
                'city' => 'required_if:address,Newaddress|exclude_unless:address,Newaddress|string|min:2|max:255',
                'state' => 'required_if:address,Newaddress|exclude_unless:address,Newaddress|string|min:2|max:255',
