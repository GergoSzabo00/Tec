    ...
    $(document).ready(function() 
    {
        ...
        $(document).on('click', '.deleteBtn', function(e)
        {
            ...
            showDeleteConfirmModal(
                itemId,
                '{{__('Do you really want to delete this manufacturer?')}}',
                '{{__('Manufacturer deleted successfully!')}}'
            );
        });
        ...
        $('#deleteSelected').on('click', function()
        {
            ...
            if(selectedItems.length > 0)
            {
                ...
                showDeleteConfirmModal(
                    ids,
                    '{{__('Do you really want to delete the selected manufacturers?')}}',
                    '{{__('Selected manufacturers deleted successfully!')}}'
                );
            }
