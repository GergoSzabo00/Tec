    ...
    $(document).ready(function() 
    {
        dataTable = $('#dataTable').DataTable({
            ...
            columns: [
                ...
                {data: 'shipping_address', orderable: true, searchable: true},
                {data: 'phone', orderable: false, searchable: true},
                {data: 'order_status', orderable: true, searchable: true},
                {data: 'payment_option', orderable: true, searchable: true},
        ...
        $(document).on('click', '.deleteBtn', function(e)
        {
            ...
            showDeleteConfirmModal(
                itemId,
                '{{__('Do you really want to delete this order?')}}',
        ...
        $('#deleteSelected').on('click', function()
        {
            ...
            if(selectedItems.length > 0)
            {
                ...
                showDeleteConfirmModal(
                    ids,
                    '{{__('Do you really want to delete the selected orders?')}}',
                    '{{__('Selected orders deleted successfully!')}}'
                );
            }
