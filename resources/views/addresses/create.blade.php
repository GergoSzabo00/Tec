...
<form method="POST" action="{{route('address.create')}}">
    ...
    <div class="my-3">
        ...
        <div class="d-flex align-items-center">
            <h2 class="mt-4">{{__('Add new address')}}</h2>
        </div>
    </div>
    <div class="row g-3">
        <div class="col-lg-12"> 
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row g-3 mt-1">
                        ...
                        <x-forms.input id="address" name="address" type="text" class="col-lg-6" icon="location-dot" label="{{__('Address')}}" placeholder="{{ __('Address') }}" />
                    </div>
